function varargout = spectrum(p,verbose,draw_q2,spec_frequencies,mass_spectrum)
    ...
    % spec_frequencies will use the specified frequency values for the spectrum
    % You can also use params.spectrum(gcf) to plot in the current figure
    ...
    if draw_q2
    	[~,f,P,w,q2] = p.dispersion_calc(0,[],[],spec_frequencies,mass_spectrum);
    	q2 = q2.*p.re^2;
    else
    	[~,f,P] = p.dispersion_calc(1,[],spec_frequencies,mass_spectrum);
	end
